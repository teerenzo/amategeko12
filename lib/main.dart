              ...
              child: ListTile(
                title: Container(
                  ...
                  child: Padding(
                    ...
                    child: CircleAvatar(child: Image.asset("images/study.png")),
                  ),
                ),
                subtitle: Padding(
              ...
              child: ListTile(
                title: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(bottom: 12.0),
                    child:
                        CircleAvatar(child: Image.asset("images/carSign.png")),
                  ),
                ),
                subtitle: Padding(
                  padding: const EdgeInsets.only(bottom: 22.0, left: 9.0),
...
// Quiz grid
            ...
            ListTile(
              title: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(bottom: 12.0),
                  child: CircleAvatar(child: Image.asset("images/share.png")),
                ),
              ),
              subtitle: Padding(
                padding: const EdgeInsets.only(bottom: 22.0, left: 9.0),
